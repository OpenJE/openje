...
namespace JE {
    ...
    int* cls_0x4d8d70::meth_0x545710(int param_1) {
        ...
        v2 = *reinterpret_cast<int*>(static_cast<char*>(this->mbr_0x4) + 4);
        mbr_0x4_val = this->mbr_0x4;
        ...
        return reinterpret_cast<int*>(mbr_0x4_val);
    }
    ...
    int* cls_0x4d8d70::meth_0x56f520(int *param_1, int *param_2) {
        ...
        if (v5 == this->mbr_0x4 || _stricmp(str_v5, str_p2) < 0) {
